...
| `sidebar-run-feedback.spec.js` | Run feedback Yes/No after idle; mocked Yes good-run file; mocked No → filed |
| `run-feedback.spec.js` | REST mint + failure/success report proxy to mocked `feedback.wpahentic.com` intake |
