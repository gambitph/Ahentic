			...
			switch ( (string) $id ) {
				...
				case 'media':
					return 'Post images: ahentic/generate-image stages an artifact; ahentic/upload-media (from_memory) adds it to the library; '
						...
						. 'Changing a hero/banner/header/cover already on the page: compact get-blocks first; patch the block with media_kind=background '
						. '(any library\'s container/group/cover/hero background image) rather than a small nested image overlay. '
						. 'update-block-attributes remaps guessed keys onto live keys including nested background objects, '
						. 'and retargets tiny overlays to the ancestor background; do not default to set-featured-image. Generate only when they need a new image. '
