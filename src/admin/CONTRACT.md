...
5. `GET /sessions/{id}` is the poll target and includes status, messages/entries, plan, pendingTool, progress, **heartbeat** (or equivalent liveness), artifacts pointers, errors — enough for Sidebar PRD busy/slow/stuck/wait UX.
